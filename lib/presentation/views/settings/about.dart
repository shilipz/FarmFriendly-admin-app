            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    '4. Customer Interaction: Enhance communication with customers through an integrated chat feature. Address inquiries, provide updates on available produce, and build a stronger connection between your farm and the end consumers.',
                    style: TextStyle(fontSize: 16),
                  ),
                  SizedBox(height: 16.0),
                  Text(
